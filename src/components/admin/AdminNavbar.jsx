    ...
    return (
        <nav className='px-2'>
            ...
            <div className='flex flex-col gap-2.5 py-2.5 '>
                <div className='px-2'>
                    <div className='flex items-center justify-between select-none cursor-pointer py-2.5' onClick={() => dispatch(setProjectTabOpen(!projectTabOpen))} onKeyDown={(e) => { if (e.key === 'Enter') dispatch(setProjectTabOpen(!projectTabOpen)) }}>
